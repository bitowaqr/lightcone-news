...
export const forecasterRobin = async (scenarioId, save = false, log = false) => {
...
*   \`rationalDetails\` (string, optional): A more in-depth justification, elaborating on research findings. Structure clearly (paragraphs, bullet points, "PRO:", "CON:" labels).
...
//   const result = await forecasterRobin(scenarioId, true, true);
//   console.log(result);
