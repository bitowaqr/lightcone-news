...
export const forecasterStrange = async (scenarioId, save = false, log = false) => {
...
You are a professional superforecaster with an amazing track record of accurate and well-calibrated probabilistic forecasts, and you have been tasked with forecasting the likelihood of an event occurring. Your tone and style is rationalistic and extremely analytical.
...
//   const result = await forecasterStrange(scenarioId, false, true);
//   console.log(result);
