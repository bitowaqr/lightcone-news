...
dotenv.config();
  ...
  const GEMINI_MODEL = process.env.WORKER_MODEL || 'gemini-2.5-pro-preview-05-06';
...
3.  **Suggest AI Chat Prompts:**
    ...
    * Good examples: "Who is [specific not widely known person mentioned]?", "What does a [political position not widely known] do?", "How did [Company mentioned] stock perform yesterday?", "What is [abbreviation]?", "When did [person] did [event]?" - depending on the article, these prompts may provide useful additional context, and can be reliably answered by an ai chatbot with access to the internet.
    * Bad examples: "What is the impact of [event] on [country]?", "Does [country] have geopolitical influence on [other country]?", "What were the consequences of [political decision] on education levels?", "What is [entity]'s strategic position?" - these may be interesting questions, but a chatbot won't be able to provide a good answer, and the reader will be left with a feeling of dissatisfaction or even frustration.
