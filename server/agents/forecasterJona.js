...
export const forecasterGaladriel = async (scenarioId, save = false, log = false) => {
...
* First express your confidence as a percentage with one decimal place.
* Then translate into a probability between 0.001 and 0.999.
* Avoid absolute 0.0 or 1.0, and NEVER just say 0.15 or 0.85 to express that something is 'unlikely' or 'likely' - you can do so much better than that, if you think like a professional superforecaster!
...
//   const result = await forecasterGaladriel(scenarioId, false, true);
//   console.log(result);
